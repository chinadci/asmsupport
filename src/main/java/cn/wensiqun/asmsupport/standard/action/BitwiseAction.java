 ...
 */
public interface BitwiseAction<_P extends Parameterized> {
     ...
     * @return {@link Reverse}
     */
    public Reverse reverse(_P factor);
     ...
     * @return {@link BitAnd}
     */
    public BitAnd band(_P factor1, _P factor2);
     ...
     * @return {@link BitOr}
     */
    public BitOr bor(_P factor1, _P factor2);
     ...
     * @return {@link BitXor}
     */
    public BitXor bxor(_P factor1, _P factor2);
     ...
     */
    public ShiftLeft shl(_P factor1, _P factor2);
     ...
     */
    public ShiftRight shr(_P factor1, _P factor2);
     ...
     */
    public UnsignedShiftRight ushr(_P factor1, _P factor2);
